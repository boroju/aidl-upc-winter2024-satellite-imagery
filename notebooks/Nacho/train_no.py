...
from pathlib import Path
root = Path('/opt/ml/processing/input/data')
assert root.exists()
...
class WildFireDaset(RasterDataset):
    ...
    # filename_glob = "no_fire_landcover_**0.tif"
    ...
    def __getitem__(self, query: BoundingBox) -> dict[str, Any]:
        ...
        # Replace NaN values with a fixed value (e.g., 0)
...
class WildFireDataModule(GeoDataModule):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # normalize = MyNormalize(mean, std)
    ...
    def setup(self, stage: str) -> None:
        ...
        def train_dataloader(self):
            ...
            return DataLoader(self.train_dataset, sampler=self.train_sampler, batch_size=self.batch_size, collate_fn=stack_samples)
...
default_root_dir = "/opt/ml/processing/model"
